// 📂 File: antidelete.js
// 🛡️ Ultra Pro Max Anti-Delete System — LILJUICEGEQUE-MD
...
let botId = null; // 🔥 To save bots own ID
...
function storeMessage(msg) {
  ...
  // ⛔ If the sender is the bot itself, then skip
...
async function handleMessageRevocation(sock, msg) {
  ...
  // ⛔ If the deleted message was the bots own, then skip
...
Master Geque I've collected data〕
┃ 👤 𝘚𝘦𝘯𝘥𝘦𝘳: *${senderName}*
